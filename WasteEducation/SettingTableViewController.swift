...
//  UOAWE
//
//  Created by ZhouYue on 3/02/2016.
...
class SettingTableViewController: UITableViewController {
    ...
    var itemList = ["Color Blind Mode", "Notifications"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("SettingCell", forIndexPath: indexPath) as! SettingViewTableViewCell
